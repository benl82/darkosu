...
class _Unpacker:
    ...
    def parse_replay_data(replay_data_str, mode):
        ...
        for event in events:
            ...
            if mode is GameMode.MANIA:
                event = ReplayEventMania(time_delta, int(x))
    ...
    def unpack(self):
        ...
        count_320 = self.unpack_once("h")
        count_200 = self.unpack_once("h")
        ...
        return Replay(mode, game_version, beatmap_hash, username,
            replay_hash, count_300, count_100, count_50, count_320, count_200,
...
class _Packer:
    ...
    def pack(self):
        ...
        data += self.pack_short(r.count_320)
        data += self.pack_short(r.count_200)
